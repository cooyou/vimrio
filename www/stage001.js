...
function initStage001(stage){
		...
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":0,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":1*u,"y":0,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":2*u,"y":0,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":1*u,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":2*u,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":3*u,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":4*u,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":5*u,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
		...
		item=stage.createNewItem();
		item.setName("wall");
		item.addAnimation({"dsp":true,"x":0,"y":6*u,"w":u,"h":u,"img":"brick01.png","bgc":"BlanchedAlmond","bdc":"peru"});
		stage.addItem(item);
